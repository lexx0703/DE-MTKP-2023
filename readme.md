...
* [Модуль 3: Разработка баз данных, объектов баз данных и импорт.](/Moduls/AdmDB_mod_3.pdf)
   ...
   [Файлы данных](/Moduls/ResourseFile) к `Модулю 3`. Дамп базы данных с импортированными данными из [файлов](/Variant_1_2022/Сессия%201) для импорта [MySql](/Help/After_analyzing_files.sql)
